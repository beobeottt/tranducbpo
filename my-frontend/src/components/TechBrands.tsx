...
const TechBrands: React.FC = () => {
  const brands: Brand[] = [
    ...
    },
    {
      id: "xiaomi",
      name: "Xiaomi",
      logo: "https://seeklogo.com/images/X/xiaomi-mi-logo-7E3F77B723-seeklogo.com.png",
      icon: <Smartphone className="w-10 h-10" />,
      href: "/brand/xiaomi",
    },
    {
      id: "sony",
      name: "Sony",
      logo: "https://seeklogo.com/images/S/sony-logo-1F8E8E1CDA-seeklogo.com.png",
    ...
    },
    {
      id: "lenovo",
      name: "Lenovo",
      logo: "https://1000logos.net/wp-content/uploads/2017/03/Lenovo-Logo.png",
      icon: <Laptop className="w-10 h-10" />,
      href: "/brand/lenovo",
    },
    {
    ...
    },
    {
      id: "lg",
      name: "LG",
      logo: "https://seeklogo.com/images/L/lg-logo-9E82785A39-seeklogo.com.png",
      icon: <Monitor className="w-10 h-10" />,
      href: "/brand/lg",
    },
    {
      id: "oppo",
      name: "OPPO",
      logo: "https://seeklogo.com/images/O/oppo-logo-1F8DB77B50-seeklogo.com.png",
      icon: <Smartphone className="w-10 h-10" />,
      href: "/brand/oppo",
    },
  ];
